...
logger = configure_logging("vms_service")
...
add_audit_middleware(app, service_name="vms_service")
...
@app.post("/api/v1/clips/generate", response_model=ClipResponse)
...
@app.get("/api/v1/clips/{event_id}/url")
...
@app.get("/api/v1/clips", response_model=ClipListResponse)
...
@app.delete("/api/v1/clips/{event_id}")
