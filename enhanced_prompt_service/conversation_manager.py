...
class ConversationManager:
    ...
    async def add_message(
        ...
        self.redis.expire(messages_key, self.conversation_ttl)
    ...
    async def get_recent_messages(
        ...
        message_ids = self.redis.zrevrange(messages_key, 0, limit - 1)
    ...
    async def get_message_count(self, conversation_id: str) -> int:
        ...
        messages_key = f"conversation_messages:{conversation_id}"
        return self.redis.zcard(messages_key)
    ...
    async def get_user_conversations(
        ...
        conversation_ids = self.redis.zrevrange(user_conversations_key, 0, limit - 1)
    ...
    async def delete_conversation(self, conversation_id: str) -> bool:
        ...
        # Delete all messages
        messages_key = f"conversation_messages:{conversation_id}"
        message_ids = self.redis.zrange(messages_key, 0, -1)
